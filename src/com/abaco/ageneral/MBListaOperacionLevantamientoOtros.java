...
@ManagedBean(name = "mblistaoperacionlevantamientootros")
@ViewScoped
public class MBListaOperacionLevantamientoOtros implements Serializable {
	...
	public void inicializar() {
		visualizarTabGarantiaVigente = true;
	}
